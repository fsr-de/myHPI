    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('already_voted', models.ManyToManyField(blank=True, related_name='base_polls', to=settings.AUTH_USER_MODEL)),
                ('eligible_groups', modelcluster.fields.ParentalManyToManyField(blank=True, related_name='base_polls', to='auth.group')),
            ],
            options={
                'abstract': False,
            },
